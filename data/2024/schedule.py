schedule = [
    ...
    },
    {
        ...
        "realm": 'Sea Realm',
        "description": 'Join Brad for a session on the evolution of maritime security threats, where you will journey from traditional piracy to the emerging challenge of cyber attacks. Discover how the landscape of maritime security has transformed over the years and the innovative strategies being employed to combat these threats. Featuring an in-depth case study on modern-day piracy defense and a detailed look into an onboard cyber assessment for a ship.',
    ...
    },
    {
        ...
        "realm": 'Cognitive Realm',
        "description": "Dr. Carlopio will discuss information warfare, from both the Nation-State sponsored and cybercrime perspectives, looking at recent examples, what we can expect in the not-too-distant future, and what we can do about it.",
    ...
    },
    {
        ...
        "title": 'Cyberwar',
        "realm": 'Multi Realm',
        "description": 'How does conflict and cyber effects play out into the real world Whilst a lot of theory, speculation and "Cyber is good children are our future" conceptual thinking plays out, there are some realities to appreciate if contention or outright conflict takes place. I wanted to work through recent occurrences in Ukraine, the influence conflict plays as well as technical appreciation for prospective scenarios that may exist in Australia and the Asia Pacific.',
